        ...
        while True:
            with tf.GradientTape() as policy_tape:
                ...
                with tf.GradientTape() as value_tape:
                    ...
                    td_target = ep_rew + 0.99 * value_next
                    value_loss = value_network.compute_loss(value_current, td_target, value_reg)
            ...
            policy_grads = [a * td_error for a in policy_grads]
            ...
            if is_done(distance, t, args):
                if len(ep_rewards) > 5:
                    for i, grad_pol in enumerate(ep_log_grad):
